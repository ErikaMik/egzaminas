...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="recourses/css/dist/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="recourses/css/starter-template.css" rel="stylesheet">

    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
    <script src="/vendor/twbs/bootstrap/site/docs/4.3/assets/js/src/ie-emulation-modes-warning.js"></script>
